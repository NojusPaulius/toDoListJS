...
/* harmony import */ var _modules_createTableRows__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/createTableRows */ "./src/modules/createTableRows.js");
...
(0,_modules_createTableRows__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
var checkButton = function checkButton() {
  ...
  tablebody.addEventListener("click", function (event) {
    ...
    if (clickedElement.classList.contains("table__button-img")) {
      var _checkButton = clickedElement;
      var row = _checkButton.closest(".table__row");
      var task = row.querySelector(".table__row-text");
      var status = row.querySelector("#task-status");
      var buttonStatus = row.getAttribute("data-button-status") === "true"; // place it somewhere so that every row gets one of these, code does some wonky shit,
      console.log(_checkButton);
      ...
      if (!buttonStatus) {
        ...
        _checkButton.setAttribute("src", "/src/images/checked.png");
        ...
        _checkButton.setAttribute("src", "/src/images/unchecked.png");
...
/***/ "./src/modules/createTableRows.js":
/*!****************************************!*\
  !*** ./src/modules/createTableRows.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var createTableRow = function createTableRow() {
...
var saveToLocal = function saveToLocal(e) {
  var saveButton = document.querySelector(".modal__saveButton");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmain_file"] = self["webpackChunkmain_file"] || [];
